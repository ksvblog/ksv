...
!(function () {
  ...
  var T = R((s((c = {}), I, { fa: 'solid', fas: 'solid', 'fa-solid': 'solid', far: 'regular', 'fa-regular': 'regular', fal: 'light', 'fa-light': 'light', fat: 'thin', 'fa-thin': 'thin', fad: 'duotone', 'fa-duotone': 'duotone', fab: 'brands', 'fa-brands': 'brands', fak: 'kit', 'fa-kit': 'kit' }), s(c, L, { fa: 'solid', fass: 'solid', 'fa-solid': 'solid', fasr: 'regular', 'fa-regular': 'regular', fasl: 'light', 'fa-light': 'light' }), c)),
    ...
    H = R((s((b = {}), I, { 'fa-brands': 'fab', 'fa-duotone': 'fad', 'fa-kit': 'fak', 'fa-light': 'fal', 'fa-regular': 'far', 'fa-solid': 'fas', 'fa-thin': 'fat' }), s(b, L, { 'fa-solid': 'fass', 'fa-regular': 'fasr', 'fa-light': 'fasl' }), b)),
  ...
  var V = []
      .concat(Y, l(b), ['2xs', 'xs', 'sm', 'lg', 'xl', '2xl', 'beat', 'border', 'fade', 'beat-fade', 'bounce', 'flip-both', 'flip-horizontal', 'flip-vertical', 'flip', 'fw', 'inverse', 'layers-counter', 'layers-text', 'layers', 'li', 'pull-left', 'pull-right', 'pulse', 'rotate-180', 'rotate-270', 'rotate-90', 'rotate-by', 'shake', 'spin-pulse', 'spin-reverse', 'spin', 'stack-1x', 'stack-2x', 'stack', 'ul', q.GROUP, q.SWAP_OPACITY, q.PRIMARY, q.SECONDARY])
      .concat(
        f.map(function (t) {
          return ''.concat(t, 'x');
        }),
  ...
  c = { styleDefault: 'solid', familyDefault: 'classic', cssPrefix: 'fa', replacementClass: A, autoReplaceSvg: !0, autoAddCss: !0, autoA11y: !0, searchPseudoElements: !1, observeMutations: !0, mutateApproach: 'async', keepOriginalSource: !0, measurePerformance: !1, showMissingIcons: !0 };
  ...
  function Zt(t) {
    ...
    return (
      ...
      (t.attributes = n),
      s
        ? ((v = (p = t).prefix), (g = p.iconName), (h = p.children), (y = p.attributes), (p = !0 === (p = p.symbol) ? ''.concat(v, '-').concat(J.cssPrefix, '-').concat(g) : p), [{ tag: 'svg', attributes: { style: 'display: none;' }, children: [{ tag: 'symbol', attributes: k(k({}, y), {}, { id: p }), children: h }] }])
        : ((g = (v = t).children), (y = v.main), (p = v.mask), (h = v.attributes), (t = v.styles), ot((v = v.transform)) && y.found && !p.found && ((p = y.width / y.height / 2), (y = 0.5), (h.style = rt(k(k({}, t), {}, { 'transform-origin': ''.concat(p + v.x / 16, 'em ').concat(y + v.y / 16, 'em') })))), [{ tag: 'svg', attributes: h, children: g }])
    );
  }
  function $t(t) {
    var a = t.content,
    ...
    ot(i) &&
      ((s.transform =
        ...
        (e = ''),
        (e += c && w ? 'translate('.concat(o.x / Z - (void 0 === i ? x : i) / 2, 'em, ').concat(o.y / Z - n / 2, 'em) ') : c ? 'translate(calc(-50% + '.concat(o.x / Z, 'em), calc(-50% + ').concat(o.y / Z, 'em)) ') : 'translate('.concat(o.x / Z, 'em, ').concat(o.y / Z, 'em) ')),
  ...
  function na(i, r) {
    ...
    return (
      ...
      new Promise(function (t, a) {
        ...
        (e = i), (n = r), M || J.showMissingIcons || !e || console.error('Icon with name "'.concat(e, '" and prefix "').concat(n, '" is missing.')), t(k(k({}, ea), {}, { icon: (J.showMissingIcons && i && qt('missingIconAbstract')) || {} }));
      })
    );
  }
  function ia() {}
      ...
      c = e.styleParser
        ? ((e = (c = t).getAttribute('style')),
          ...
          (c = e
            ...
            : c))
        : [];
    return k({ iconName: i, title: t.getAttribute('title'), titleId: t.getAttribute('data-fa-title-id'), prefix: r, transform: $, mask: { iconName: null, prefix: null, rest: [] }, maskId: null, symbol: !1, extra: { classes: o, styles: c, attributes: s } }, a);
  }
  var Aa = ut.styles;
  function Oa(t) {
        ...
        (t.i2svg = function (t) {
          ...
          (t.generateAbstractIcon = function (t) {
            var a,
              ...
              r = t.transform,
              t = rt(t.styles);
            return 0 < t.length && (n.style = t), ot(r) && (a = qt('generateAbstractTransformGrouping', { main: i, transform: r, containerWidth: i.width, iconWidth: i.width })), e.push(a || i.icon), { children: e, attributes: n };
          });
      },
    },
    a = {
        ...
        return {
          text: function (t) {
            ...
            return Qt({ type: 'text', content: t }, function () {
              return Bt('beforeDOMElementCreation', { content: t, params: a }), $t({ content: t, transform: k(k({}, $), n), title: i, extra: { attributes: o, styles: s, classes: [''.concat(J.cssPrefix, '-layers-text')].concat(l(r)) } });
            });
          },
        };
      },
      provides: function (t) {
        t.generateLayersText = function (t, a) {
          var e,
            ...
            o = null,
            s = null;
          return w && ((e = parseInt(getComputedStyle(t).fontSize, 10)), (o = (a = t.getBoundingClientRect()).width / e), (s = a.height / e)), J.autoA11y && !n && (r.attributes['aria-hidden'] = 'true'), Promise.resolve([t, $t({ content: t.innerHTML, width: o, height: s, transform: i, title: n, extra: r, watchable: !0 })]);
        };
      },
    },
    ja = new RegExp('"', 'ug'),
    ...
    return new Promise(function (e, t) {
      ...
      u && 'none' !== d && '' !== d
        ? ((s = l.getPropertyValue('content')),
          ...
          (d = (l = ((l = (d = s).replace(ja, '')), (a = 0), (s = (m = l).length), (c = 55296 <= (d = m.charCodeAt(a)) && d <= 56319 && a + 1 < s && 56320 <= (c = m.charCodeAt(a + 1)) && c <= 57343 ? 1024 * (d - 55296) + c - 56320 + 65536 : d), (d = Ea[0] <= c && c <= Ea[1]), { value: yt((c = 2 === l.length && l[0] === l[1]) ? l[0] : l), isSecondary: d || c })).value),
          (c = l.isSecondary),
          ...
          !u || c || (f && f.getAttribute(C) === n && f.getAttribute(S) === i)
            ...
            : (b.setAttribute(v, i),
              f && b.removeChild(f),
              ((o = (r = { iconName: null, title: null, titleId: null, prefix: null, transform: $, symbol: !1, mask: { iconName: null, prefix: null, rest: [] }, maskId: null, extra: { classes: [], styles: {}, attributes: {} } }).extra).attributes[N] = p),
              na(u, n)
                .then(function (t) {
          ...
          g.matchMedia && (r = g.matchMedia('(prefers-reduced-motion: reduce)').matches),
            (t.missingIconAbstract = function () {
              ...
              return (
                ...
                t.push(i),
                t.push({ tag: 'path', attributes: k(k({}, a), {}, { opacity: '1', d: 'M263.7,312h-16c-6.6,0-12-5.4-12-12c0-71,77.4-63.9,77.4-107.8c0-20-17.8-40.2-57.4-40.2c-29.1,0-44.3,9.6-59.2,28.7 c-3.9,5-11.1,6-16.2,2.4l-13.1-9.2c-5.6-3.9-6.9-11.8-2.6-17.2c21.2-27.2,46.4-44.7,91.2-44.7c52.3,0,97.4,29.8,97.4,80.2 c0,67.6-77.4,63.5-77.4,107.8C275.7,306.6,270.3,312,263.7,312z' }), children: r ? [] : [{ tag: 'animate', attributes: k(k({}, n), {}, { values: '1;0;0;0;0;1;' }) }] }),
                r || t.push({ tag: 'path', attributes: k(k({}, a), {}, { opacity: '0', d: 'M232.5,134.5l7,168c0.3,6.4,5.6,11.5,12,11.5h9c6.4,0,11.7-5.1,12-11.5l7-168c0.3-6.8-5.2-12.5-12-12.5h-23 C237.7,122,232.2,127.7,232.5,134.5z' }), children: [{ tag: 'animate', attributes: k(k({}, n), {}, { values: '0;0;1;1;0;0;' }) }] }),
